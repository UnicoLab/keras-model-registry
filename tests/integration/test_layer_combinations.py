...
class TestLayerCombinations(unittest.TestCase):
    ...
    def test_embedding_fusion_pipeline(self):
    ...
    def test_attention_transformer_pipeline(self):
    ...
    def test_variable_selection_with_context(self):
        """Test variable selection with context."""
        # Create pipeline - VariableSelection expects 3D input
        inputs = keras.Input(shape=(self.num_features, 1))  # (batch, features, feature_dim)
    ...
    def test_stochastic_depth_regularization(self):
...
class TestModelIntegration(unittest.TestCase):
    ...
    def test_terminator_model_integration(self):
    ...
    def test_feed_forward_model_integration(self):
