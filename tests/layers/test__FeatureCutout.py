...
class TestFeatureCutout(unittest.TestCase):
    ...
    def test_noise_value(self) -> None:
        ...
        self.assertAlmostEqual(masked_ratio, self.cutout_prob, delta=0.1)
    ...
    def test_reproducibility(self) -> None:
        ...
        layer1 = FeatureCutout(cutout_prob=self.cutout_prob, seed=self.seed)
        layer2 = FeatureCutout(cutout_prob=self.cutout_prob, seed=self.seed)
