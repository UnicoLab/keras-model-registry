...
class TestHyperZZWOperator(unittest.TestCase):
    ...
    def test_output_shape(self) -> None:
        ...
        test_shapes = [
            ...
            (64, 32, 16),
            (128, 64, 32),
        ]  # batch_size, input_dim, context_dim
    ...
    def test_serialization(self) -> None:
        ...
        original_layer = HyperZZWOperator(
    ...
    def test_integration(self) -> None:
        ...
        x = HyperZZWOperator(input_dim=self.input_dim, context_dim=self.context_dim)(
    ...
    def test_learnable_weights(self) -> None:
        ...
        # Get updated weights
        updated_weights = model.layers[2].get_weights()[
            0
        ]  # Index 2 should be the HyperZZWOperator
