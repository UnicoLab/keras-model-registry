...
class TestTabularAttention(unittest.TestCase):
    ...
    def test_output_shape(self):
        ...
        # Check output shape
        self.assertEqual(output.shape, (self.batch_size, self.num_samples, self.d_model))
        
        # Test compute_output_shape method
        computed_shape = layer.compute_output_shape((self.batch_size, self.num_samples, self.num_features))
        self.assertEqual(computed_shape, (self.batch_size, self.num_samples, self.d_model))
    ...
    def test_model_integration(self):
        ...
        x_data = np.random.normal(size=(self.batch_size, self.num_samples, self.num_features))
    ...
    def test_attention_mechanism(self):
        ...
        pattern_input = np.zeros((1, self.num_samples, self.num_features), dtype=np.float32)
