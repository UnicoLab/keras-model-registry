...
class TestTransformerBlock(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.test_2d_input = tf.random.normal((self.batch_size, self.feature_dim))
    ...
    def test_serialization(self) -> None:
        ...
        self.assertEqual(
            reconstructed_transformer.dim_model,
            original_transformer.dim_model,
        )
        self.assertEqual(
            reconstructed_transformer.num_heads,
            original_transformer.num_heads,
        )
        self.assertEqual(
            reconstructed_transformer.ff_units,
            original_transformer.ff_units,
        )
        self.assertEqual(
            reconstructed_transformer.dropout_rate,
            original_transformer.dropout_rate,
        )
    ...
    def test_model_integration(self) -> None:
        ...
        x = TransformerBlock(dim_model=self.feature_dim, num_heads=4, ff_units=64)(
            inputs,
        )
