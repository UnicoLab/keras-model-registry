...
class TestVariableSelection(unittest.TestCase):
    ...
    def test_invalid_initialization(self):
        ...
        with self.assertRaises(ValueError):
            VariableSelection(nr_features=self.nr_features, units=self.units, dropout_rate=1.5)
    ...
    def test_invalid_input_shape_without_context(self):
    ...
    def test_invalid_input_shape_with_context(self):
    ...
    def test_output_shape_without_context(self):
        ...
        computed_shapes = layer.compute_output_shape((self.batch_size, self.nr_features))
    ...
    def test_feature_weights_sum_to_one(self):
        ...
        # Without context
        layer_no_context = VariableSelection(nr_features=self.nr_features, units=self.units)
        ...
        _, feature_weights_with_context = layer_with_context([self.features, self.context])
    ...
    def test_training_mode(self):
        ...
        self.assertFalse(np.allclose(selected_training.numpy(), selected_inference.numpy()))
    ...
    def test_model_integration_without_context(self):
    ...
    def test_model_integration_with_context(self):
        ...
        # Create model
        model = Model(
            inputs=[feature_inputs, context_inputs], 
            outputs=outputs
        )
