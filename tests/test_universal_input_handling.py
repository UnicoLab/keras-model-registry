...
class TestUniversalInputHandling:
    ...
    def test_feed_forward_universal_inputs(self):
        ...
        single_input = np.concatenate([test_data["feature_1"], test_data["feature_2"]], axis=-1)
    ...
    def test_models_with_preprocessing(self):
        ...
        x = layers.Dense(10, activation='relu', name='preprocessing_dense')(preprocessing_input)
        preprocessing_model = keras.Model(inputs=preprocessing_input, outputs=x, name='preprocessing_model')
